        ...
        <table class="table table-bordered table-hover module-list">
          <thead>
			...
			<?php if ($sort == 'id.title') { ?>
				<a href="<?php echo $sort_title; ?>" class="<?php echo strtolower($order); ?>"><?php echo $lang['column_title']; ?></a>
            <?php } else { ?>
			...
			<?php if ($sort == 'i.sort_order') { ?>
                <a href="<?php echo $sort_sort_order; ?>" class="<?php echo strtolower($order); ?>"><?php echo $lang['column_link']; ?></a>
            <?php } else { ?>
			...
			<td class="left">
			<?php if ($sort == 'id.title') { ?>
                <a href="<?php echo $sort_sort_order; ?>" class="<?php echo strtolower($order); ?>"><?php echo $lang['column_sort_order']; ?></a>
            <?php } else { ?>
