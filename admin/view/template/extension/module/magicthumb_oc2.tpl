...
<div id="content">
<form action="<?php echo $action; ?>" method="post" id="form-magicthumb" name="form-magicthumb" class="form-horizontal">
    <div class="page-header">
	<div class="container-fluid">
	    <div class="pull-right">
		<button type="submit" form="form-magicthumb" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <ul class="nav nav-tabs">
	...
	<div class="tab-pane  active" id="tab-general">
		...
		<div class="panel-body <?php echo $toolAbr; ?>params">
			...
			<label class="col-sm-2 control-label" for="magicthumbsettingStatus">Enable/Disable module</label>
			<div class="col-sm-10">
			  <select name="magicthumb_status" class="form-control">
				<option value="1" <?php echo (($magicthumb_status) ? 'selected' : ''); ?> ><?php echo $text_enabled; ?></option>
				<option value="0" <?php echo ((!$magicthumb_status) ? 'selected' : ''); ?> ><?php echo $text_disabled; ?></option>
			  </select>
			  <input type="hidden" name="magicthumb_status_was" value="<?php echo $magicthumb_status; ?>">
			</div>
		    </div>
	    ...
	    <div class="panel panel-default">
		    ...
		    <div class="panel-body <?php echo $toolAbr; ?>params">
				<div class="form-group">
				<label class="col-sm-2 control-label" for="magicthumbsettingChache-path">Path to cache folder</label>
				<div class="col-sm-10">
				...
				<div class="form-group">
				<label class="col-sm-2 control-label" for="magicthumbsettingTotal-items">Total items</label>
				<div class="col-sm-10">
						<input class="form-control" type="text" size="60" value="<?php echo $total_items; ?>" disabled="disabled" />
				</div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label" for="magicthumbsettingUnuser-items">Unused items</label>
				<div class="col-sm-10">
						<input class="form-control" type="text" size="60" value="<?php echo $unused_items; ?>" disabled="disabled" />
				</div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label" for="magicthumbsettingEmpte-chache">Empty cache</label>
				<div class="col-sm-10">
