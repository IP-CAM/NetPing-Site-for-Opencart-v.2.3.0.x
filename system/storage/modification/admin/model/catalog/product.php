...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		$product_id = $this->db->getLastId();
                   ...
                   if (isset($data['product_mmos_shortdescr'])) {
                         $this->load->model('catalog/mmos_shortdescr'); 
                        $this->model_catalog_mmos_shortdescr ->insert($product_id, $data);
                      }                       
	...
	public function copyProduct($product_id) {
		...
		if ($query->num_rows) {
			...
			$data['product_recurrings'] = $this->getRecurrings($product_id);
                         ...
                         $this->load->model('catalog/mmos_shortdescr'); 
                        $data['product_mmos_shortdescr'] =  $this->model_catalog_mmos_shortdescr->get_desrc_product_copy($product_id);
